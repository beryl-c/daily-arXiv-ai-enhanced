...
### [109] [Not All 4-bit Quantizers Are Equal: Deployment-Time Mitigation of PII Leakage in Fine-Tuned Small Language Models](https://arxiv.org/abs/2609.25014)
...
### [110] [CPyGraph: A Version-Aware Static Analysis Framework for Native CPython Bytecode](https://arxiv.org/abs/2609.25083)
*Baihong Chen,Wen Li*
...
### [111] [Benchmarking Neural Defend ARCAS 1B: A Foundational Multimodal Deepfake Detection Model](https://arxiv.org/abs/2609.25154)
...
### [112] [Attack Success Rate Is Not a Number: On Measurement Validity in Agentic AI Security Evaluation](https://arxiv.org/abs/2609.25173)
...
### [113] [Partition-Matched Evaluation of Community Features under Distribution Shift in Android Malware Function-Call Graphs](https://arxiv.org/abs/2609.25256)
...
### [114] [Controller-Only False Confirmation in Passive RF UAV Link Detection](https://arxiv.org/abs/2609.25294)
...
### [115] [SSP-Bench: A Hybrid Data Generation Framework for Safety, Security, and Privacy Evaluation](https://arxiv.org/abs/2609.25352)
...
### [116] [Quantum ROP: Using Quantum Algorithms for ROP Chain Selection in Exploit Construction](https://arxiv.org/abs/2609.25364)
*Carlos Benitez*
...
### [117] [Identifying Suspected Mislabeled Apps in Google Play Application Removal Prediction: An Empirical Comparison of Label Noise Detection Methods](https://arxiv.org/abs/2609.25487)
...
### [118] [FASTAR: FRI Accelerator for Scalable Transparent ARguments of Knowledge](https://arxiv.org/abs/2609.25535)
...
### [119] [Rethinking Backdoor Repair Evaluation: Distinguishing Aggregate Clean Utility from Benign Performance Preservation](https://arxiv.org/abs/2609.25579)
...
### [120] [SLED-IFV: Solver-Validated LLM-Guided Decomposition for Scalable Hardware Information-Flow Verification](https://arxiv.org/abs/2609.25637)
...
### [121] [C-to-Rust Fallacy: Automatic Refactoring != Memory Security](https://arxiv.org/abs/2609.25682)
...
### [122] [GuidedRay: Diversity-Guided Direction Discovery for Targeted Hard-Label Black-Box Attacks](https://arxiv.org/abs/2609.25734)
...
### [123] [Adaptive Traffic Camouflage: Causal and Resource-Aware Defense Against IoT Fingerprinting](https://arxiv.org/abs/2609.25787)
...
### [124] [CRT-Decomposed $Σ$-Protocols for CSIDH](https://arxiv.org/abs/2609.26258)
*I. Dey,I. Cherkaoui*
...
### [125] [On the Construction of Trapdoor Claw-Free Functions with Certifiable Key](https://arxiv.org/abs/2609.25819)
*Charles Lim,Yao Ma*
...
### [126] [COBRA: A Content-Agnostic Framework for Zero-Day Detection of Suspicious Domains](https://arxiv.org/abs/2609.25882)
...
### [127] [LoRango: It Takes Two LoRAs to Unlock Hidden Behaviors in Diffusion Models](https://arxiv.org/abs/2609.25884)
...
### [128] [How It's Made: Uncovering Detection Engineering Processes for Network Intrusion Detection Rules](https://arxiv.org/abs/2609.25901)
...
### [129] [Toward Responsible AI-Augmented Cyber Defense: Pattern Recognition, Defense-in-Depth, and the Case for Human-AI Collaboration](https://arxiv.org/abs/2609.25921)
...
### [130] [Policy-Backed Selective Regeneration under Tainted Inter-Agent Communication](https://arxiv.org/abs/2609.26072)
...
### [131] [Learning to Link: Automatic Re-identification of BLE Devices Under MAC Address Randomisation](https://arxiv.org/abs/2609.26079)
...
### [132] [From Bilinear to Linear: Differentially Private Federated LoRA via Low-Dimensional Parameterization](https://arxiv.org/abs/2609.26091)
...
### [133] [Beyond Classification Accuracy: Quantifying Fingerprint Complexity in Encrypted Darknet Services](https://arxiv.org/abs/2609.26096)
...
### [134] [A Cross-Dataset based Zero-Day Intrusion Detection System by Integrating Siamese Network and Reinforcement Learning](https://arxiv.org/abs/2609.26115)
...
### [135] [Zeta-Transform Evaluation for Higher-Order Vanishing Key Recovery](https://arxiv.org/abs/2609.26132)
...
### [136] [The Uncontrolled Variable: Vision-Language Model Refusal Responds to Image Presence in Ways Risk Cannot Explain](https://arxiv.org/abs/2609.26174)
...
### [137] [Refusal without Discrimination: What Encoded Prompts Do to Safety-Trained Models](https://arxiv.org/abs/2609.26176)
...
### [138] [Unread or Unenforced? Separating Representation from Enforcement Failure in Content Guards](https://arxiv.org/abs/2609.26178)
...
### [139] [Dynamic Deep Prompt Optimization for Defending Against Jailbreak Attacks on LLMs](https://arxiv.org/abs/2609.26185)
...
### [140] [Who Assures the Verifier? An Executable Assurance-Locus Audit of the European Digital Identity Wallet](https://arxiv.org/abs/2609.26220)
*Anton Sokolov*
...
### [141] [Quantum-Ready Secure WAN: A Risk Assessment and Migration Framework](https://arxiv.org/abs/2609.26225)
*Saeed Alam*
...
### [142] [Towards Effective Black-Box Adversarial Attacks on Deep Code Models via Structural and Identifier Perturbations](https://arxiv.org/abs/2609.26234)
...
### [143] [eBPF Security in the Wild: Structural Concentration, Failure Mechanisms, and Discovery Gaps](https://arxiv.org/abs/2609.26254)
...
### [144] [Image-Based Techniques and Ensemble Soft Voting for Malware Classification](https://arxiv.org/abs/2609.26281)
...
### [145] [Neural Fingerprints for Malware Analysis: An Image-Based Metric Learning Approach with Application to Cross-Domain Classification](https://arxiv.org/abs/2609.26282)
...
### [146] [A Throughput-Oriented Analytical Model for Post-Quantum Security Protocols](https://arxiv.org/abs/2609.26284)
...
### [147] [On the security and privacy of LLMs in Mobility](https://arxiv.org/abs/2609.26295)
...
### [148] [Staged Multi-step UTXO Workflows via Recursive Invariants](https://arxiv.org/abs/2609.26305)
...
### [149] [Design and Evaluation of a Controlled Post-Alert Incident Orchestration and Response Subsystem Using a Rule Engine and a Local Large Language Model](https://arxiv.org/abs/2609.26316)
...
### [150] [HYDRA: Proactive Android Malware Drift Adaptation via Hierarchical Graph Contrastive Learning](https://arxiv.org/abs/2609.26352)
...
### [151] [Formally Modeling the Terrapin Attack on SSH](https://arxiv.org/abs/2609.26358)
...
### [152] [Rouxii: Exploiting Honeypots with Deception-Aware AI Pentesters](https://arxiv.org/abs/2609.26555)
...
### [153] [Decoding the Legalese: A Scalable and Quantitative Framework for Analyzing Corporate Privacy Policies](https://arxiv.org/abs/2609.26680)
...
### [154] [From Alignment to Access Control: A Framework for GenAI Policy Enforcement](https://arxiv.org/abs/2609.26682)
*Nathalie Baracaldo*
...
### [155] [A2M: Trace-Optimized Agent Hijacking in the MCP Ecosystem](https://arxiv.org/abs/2609.26761)
...
### [156] ["As a Language Model...": Chat Template Switches LLM Self-Referential Voice and Activation Steering Reproduces It](https://arxiv.org/abs/2609.25021)
*Jędrzej Maczan*
...
### [157] [Federating Quantum and Classical Computing: A Privacy-Preserving Hybrid Approach](https://arxiv.org/abs/2609.25082)
...
### [158] [Entropy Can Flow, or It Can Guide. Be Entropy. LEDFlow: Introducing Entropy-guided Generation Order into Uniform Discrete Flow](https://arxiv.org/abs/2609.25131)
...
### [159] [The Probabilistic Structure of Large Language Models](https://arxiv.org/abs/2609.25134)
*Adnan Aboulalaâ*
...
### [160] [Stable Unsupervised Continual Chunking with Sheaf SyncMap](https://arxiv.org/abs/2609.25143)
...
### [161] [Brain-Inspired Hierarchical Modularity for General Continual Learning](https://arxiv.org/abs/2609.25146)
...
### [162] [Dual-GNN Multilevel Coarsening for Maximum Independent Set](https://arxiv.org/abs/2609.25149)
...
### [163] [Exposing Blind Spots in Deep Imbalanced Regression Evaluation](https://arxiv.org/abs/2609.25152)
...
### [164] [Learning Neural Feedback Linearization for Data-driven Systems via Augmented Lagrangian](https://arxiv.org/abs/2609.25163)
...
### [165] [Mitigating Sequential Reappearance in Diffusion Data-Point Unlearning](https://arxiv.org/abs/2609.25166)
...
### [166] [Multi-Term Fourier Graph Neural Network with Sample Relationship Learning for Enhanced Remaining Useful Life Prediction](https://arxiv.org/abs/2609.25179)
...
### [167] [Trains but Doesn't Learn: A Post-Training Delivery Benchmark for LLM Agents as Forward-Deployed Engineers](https://arxiv.org/abs/2609.25237)
...
### [168] [Correcting Within-Group Self-Selection Bias in Prioritized Replay](https://arxiv.org/abs/2609.25297)
...
### [169] [Minimal Recurrent Behavioral Memory for Imitation under Partial Observability](https://arxiv.org/abs/2609.25757)
...
### [170] [Topological Signal Processing With Unoriented Operators](https://arxiv.org/abs/2609.25310)
...
### [171] [Gap-Free Streaming PCA Beyond Rank-One Updates: Near-Optimal Rates and Applications to Differential Privacy](https://arxiv.org/abs/2609.26508)
...
### [172] [Neural Approximation by Function Composition: Rigidity and Doubly Exponential Convergence](https://arxiv.org/abs/2609.25874)
...
### [173] [Spatiotemporal Kronecker Covariance Neural Networks](https://arxiv.org/abs/2609.25326)
...
### [174] [MT-ProtBERT: Multi-task Learning ProtBERT for Intrinsically Disordered Proteins Classification with Scarce Data](https://arxiv.org/abs/2609.25334)
...
### [175] [Deep Reinforcement Learning on Item-Compatibility Graphs for One-Dimensional Bin Packing](https://arxiv.org/abs/2609.25397)
*M. Aslı Aydın*
...
### [176] [Concept Drift from a Causal Perspective](https://arxiv.org/abs/2609.25340)
...
### [177] [Continuous Optimization for p-adic Models](https://arxiv.org/abs/2609.25501)
...
### [178] [Extending FunctionGemma for Practical On-Device Mobile Function Calling](https://arxiv.org/abs/2609.25373)
...
### [179] [A Practical Recipe for Semi-Supervised Federated ASR: Online Pseudo-Labels with Server Update Stabilization](https://arxiv.org/abs/2609.25471)
...
### [180] [Predictive Uncertainty for Neural CAE Surrogates](https://arxiv.org/abs/2609.25430)
...
### [181] [Lightweight Ranking Heads: Accelerating Multi-Task Experimentation in Production Recommender Systems](https://arxiv.org/abs/2609.25433)
...
### [182] [Efficient Cost-Aware LLM Evaluation via Bayesian Bandit Gittins Indices](https://arxiv.org/abs/2609.25645)
...
### [183] [PermuFormer: Multi-Task Pretraining for Permutation Representation in Algebraic Combinatorics](https://arxiv.org/abs/2609.25438)
*Henry Kvinge*
...
### [184] [Beyond Class Marginals: Bounding Rehearsal Gaps without Freezing Class Co-occurrence](https://arxiv.org/abs/2609.25735)
...
### [185] [Mean Velocity Matching: Rethinking Generative Dynamics in Diffusion Models](https://arxiv.org/abs/2609.25444)
...
### [186] [Beyond Scalar Sensitivity: Activation-Aware Mixed-Precision LLM Quantization with Cross-Layer Refinement](https://arxiv.org/abs/2609.25916)
...
### [187] [xWhyL: Causal Interactive Learning](https://arxiv.org/abs/2609.26037)
...
### [188] [Terminal Shrinkage Averaging Reveals a Schedule-Estimator Interaction in LLM Pretraining](https://arxiv.org/abs/2609.25482)
...
### [189] [Learning Defensive Policies against Diverse Inference Attacks for Smart Meter Privacy](https://arxiv.org/abs/2609.25484)
...
### [190] [Hill Sampling for Test-Time Scaling: A Simple and Better Alternative to Repeated Sampling, Evolution, and Training](https://arxiv.org/abs/2609.25510)
...
### [191] [A JEPA Recipe for Tabular Foundation Models](https://arxiv.org/abs/2609.25541)
...
### [192] [DefaultGNN: A Dual-Perspective GNN Framework for Predicting Corporate Default from Buyer-Seller Transaction Networks](https://arxiv.org/abs/2609.25542)
...
### [193] [SambaGraph: Action-Reaction Spatio-Temporal Graphs for Soccer Tactical Response Modeling](https://arxiv.org/abs/2609.25569)
...
### [194] [EMGBlend: Heterogeneity-Aware Self-Supervised Pretraining for Gesture and Force Decoding](https://arxiv.org/abs/2609.25582)
...
### [195] [Rewired or Gated? How Instruction Tuning Shapes Knowledge-Conflict Circuits in LLMs](https://arxiv.org/abs/2609.25602)
...
### [196] [What Should a Self-Teacher See? Privileged Context Design for On-Policy Self-Distillation](https://arxiv.org/abs/2609.25623)
...
### [197] [An Exploratory Replica-Overlap Probe of the Grokking Transition](https://arxiv.org/abs/2609.25634)
*A. C. Opus,J. Q. Lu*
...
### [198] [From Experts to Sub-experts: Fine-grained Parameter-Efficient Fine-Tuning for MoE LLMs](https://arxiv.org/abs/2609.25655)
...
### [199] [Targeted Review for AI-Assisted Biodiversity Surveys: Active Continuous-Score Occupancy Modeling](https://arxiv.org/abs/2609.25657)
...
### [200] [When Riemann flows with Wasserstein: Generative Modeling of Probability Distributions on Manifolds](https://arxiv.org/abs/2609.25659)
...
### [201] [Marginal Log-Likelihood Increments under Dirichlet-Smoothed Markov Estimation](https://arxiv.org/abs/2609.25675)
*Levin David Schwab*
...
### [202] [Graph Domain Adaptation Does Not End with Representation Learning](https://arxiv.org/abs/2609.25692)
...
### [203] [Fully Byzantine-Resilient Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2609.25701)
...
### [204] [Slow Decay and Silenced Expression: Iterated Subliminal Trait Transfer in Language-Model Lineages](https://arxiv.org/abs/2609.25721)
...
### [205] [Signed Graph Pre-Training and Prompt Learning](https://arxiv.org/abs/2609.25722)
...
### [206] [Self-Supervised Combinatorial Optimization with Constraints via Frank-Wolfe](https://arxiv.org/abs/2609.25728)
...
### [207] [Modular Norm RandOpt: Population-Efficient Ensembling through Architecture-Aware Perturbations](https://arxiv.org/abs/2609.25745)
...
### [208] [Disentangling Heterogeneous Traffic Dynamics for Multi-Step Traffic Forecasting via Adaptive Spectral Decomposition](https://arxiv.org/abs/2609.25777)
...
### [209] [A Lightweight Plastic-Memory Framework for Graph Few-Shot Class-Incremental Learning](https://arxiv.org/abs/2609.25781)
...
### [210] [Evaluating Accuracy and Probabilistic Reliability of Zero-Shot Time Series Foundation Models](https://arxiv.org/abs/2609.25788)
...
### [211] [Latest Exact Match Attention](https://arxiv.org/abs/2609.25802)
*Moritz Brösamle*
...
### [212] [Auditing Proxy-Based Validation Across Text Spans](https://arxiv.org/abs/2609.25808)
...
### [213] [You Only Need 2/3 of the Chosen Experts: An Empirical Study of Dynamic Expert Pruning in Fine-Grained MoE LLMs](https://arxiv.org/abs/2609.25809)
...
### [214] [Multi-View Fair Clustering Guided by Cross-View Sensitive Information Discrepancy](https://arxiv.org/abs/2609.25811)
...
### [215] [CacheDyG: Decoupling Temporal Propagation for Efficient Dynamic Graph Learning](https://arxiv.org/abs/2609.25814)
...
### [216] [Protocol before progress: leakage-aware evaluation of AIS trajectory prediction](https://arxiv.org/abs/2609.25827)
...
### [217] [In-Context Guidance: Learning Inter-Task Synergies via Numerical Foundational Models for Few-Shot Multitask Optimization](https://arxiv.org/abs/2609.25836)
...
### [218] [Gaussian Flow-Matching Schedules: Implications for Sampling and Training](https://arxiv.org/abs/2609.25839)
...
### [220] [AURA: Angular Update Rate Adaptation for training complex-valued neural networks](https://arxiv.org/abs/2609.25914)
...
### [221] [Certified Against Which Oracle? Execution Labels Set the Reported Risk of Conformal Abstention for Text-to-SQL](https://arxiv.org/abs/2609.25938)
...
### [222] [Exploring Solver-Level Warmstarting for Neural Network Verification](https://arxiv.org/abs/2609.25962)
...
### [223] [GeoPair: Geometry-Preserving Cross-Layer Factorization for Training-Free Transformer Compression](https://arxiv.org/abs/2609.25963)
...
### [224] [Interweaving Marginals into Multivariate Sample Paths: Training-Free Dependence Construction for Probabilistic Time Series Foundation Models](https://arxiv.org/abs/2609.25980)
...
### [225] [Theory for groupoid equivariant neural networks: an approach for steerable CNNs on bounded domains](https://arxiv.org/abs/2609.25987)
...
### [226] [The Dynamics of Quasiregular Neural Learning](https://arxiv.org/abs/2609.26018)
*Matthia Sabatelli*
...
### [227] [BOBA: Dynamic Bayesian Optimization through Bayesian Active Inference](https://arxiv.org/abs/2609.26021)
...
### [228] [MICRO: Multi-Fidelity Active Search for Severe Error Discovery](https://arxiv.org/abs/2609.26025)
...
### [229] [Towards Adaptive Federated Graph Clustering: A Global Community-aware Contrastive Learning-based Approach](https://arxiv.org/abs/2609.26063)
...
### [230] [FuncCode: Compressing Kolmogorov--Arnold Networks in Function Space with Hardware-Aware Quantization](https://arxiv.org/abs/2609.26067)
...
### [231] [Fast Matrix Multiplication in fp8: Certified Coefficient Optimization and Measured Error](https://arxiv.org/abs/2609.26077)
...
### [232] [Margin-Drop Coordinates for Cross-Budget Robustness Evaluation](https://arxiv.org/abs/2609.26081)
...
### [233] [CoEvo: Oracle-Grounded Self-Evolution of a Single Model for Multi-Step Causal Reasoning](https://arxiv.org/abs/2609.26094)
...
### [234] [Certified Mechanistic Interpretability: Lifting Single-Input Findings to Bounded Neighbourhoods](https://arxiv.org/abs/2609.26112)
...
### [235] [From Risk Scoring to Risk Allocation: A Density-Driven Framework for Diverse Monitoring in Multi-Agent Systems](https://arxiv.org/abs/2609.26146)
*Zhaohui Wang*
...
### [236] [Block-Level Weight-Space Structure Persists Under Post-Training: An Empirical Study Across LLM Families](https://arxiv.org/abs/2609.26147)
*Zhaohui Wang*
...
### [237] [Spectral Tail Interventions in Decoder-Only Language Models: Reasoning-Sensitive Weight Structure from Controlled Surgery](https://arxiv.org/abs/2609.26165)
...
### [238] [Activation-Energy Pruning for Spiking Neural Networks: Unsupervised Personalization via Spike-Count Saliency](https://arxiv.org/abs/2609.26167)
*Joseph Bingham*
...
### [239] [Component Type, Not Reconstruction Error, Predicts Attention Quantization Sensitivity](https://arxiv.org/abs/2609.26173)
...
### [240] [Partially Observed Sparse Graphs: The Unknown Sampling Rate is a Tail Index](https://arxiv.org/abs/2609.26199)
...
### [241] [Bridging the Data Gap: Digital Twin as a New Paradigm for AI-based Radio Sensing](https://arxiv.org/abs/2609.26214)
...
### [242] [Beyond Imitation: Auditing the Recoverability of Reasoning in Distilled Models](https://arxiv.org/abs/2609.26216)
...
### [243] [MSA-CITE: A Co-Adapted LoRA Specialist Ecology for Fixed-Budget Small-Model Inference](https://arxiv.org/abs/2609.26217)
...
### [244] [High-Order Liquid Evidence Modeling for Continuous and Subtle GNSS Spoofing Detection in Autonomous Driving](https://arxiv.org/abs/2609.26231)
...
### [245] [Can You Delete a Year of Market Data? Machine Unlearning Against Exact Retraining Oracles](https://arxiv.org/abs/2609.26242)
*Junyi Ye*
...
### [246] [Information-Theoretic Decoupled Prompt Tuning for Continual Learning](https://arxiv.org/abs/2609.26257)
...
### [247] [Mode Collapse Is Cheap to Detect: A Ground-Truth-Free Pre-Flight Check for Neural Samplers](https://arxiv.org/abs/2609.26272)
*Jian Xu*
...
### [248] [JAMPR+/L2D: scalable neural heuristic for constrained vehicle routing problems in dynamic environment](https://arxiv.org/abs/2609.26275)
...
### [249] [On the Effect of Bit-Level Parameter Perturbations in Machine Learning and Deep Learning Models](https://arxiv.org/abs/2609.26280)
...
### [250] [Quantifying Protocol-Induced Uncertainty in Comparative Predictive-Model Evaluation: Evidence from Large-Scale Daily PM10 Forecasting](https://arxiv.org/abs/2609.26288)
...
### [251] [CompKV: Compensation-Aware KV Selection for Long-Context LLM Inference](https://arxiv.org/abs/2609.26300)
...
### [252] [PreGS: A Parameter-Transfer-Based Multi-Expert Graph Neural Network for Node Classification](https://arxiv.org/abs/2609.26310)
...
### [253] [Disaggregated Quantization: Specializing LLM Prefill and Decode](https://arxiv.org/abs/2609.26333)
...
### [254] [Geometry-Aware Hyperbolic Residual Quantization](https://arxiv.org/abs/2609.26342)
...
### [255] [PACT: From Credit Assignment to Critic Alignment](https://arxiv.org/abs/2609.26355)
...
### [256] [FairMean: Promoting Fairness in Distributed Learning under Label Poisoning Attacks](https://arxiv.org/abs/2609.26377)
...
### [257] [Learning to Defer with Guidance on Real World Medical Data](https://arxiv.org/abs/2609.26384)
...
### [258] [TimeInteract: Towards Real-Time Interactive Intelligence for Streaming Time Series](https://arxiv.org/abs/2609.26389)
...
### [259] [Double Descent and Malign Overfitting in Diffusion Models](https://arxiv.org/abs/2609.26392)
...
### [260] [OMatG-flash: An All-Atom Flow Map with Reinforce Adjoint Matching for Scalable Materials Discovery](https://arxiv.org/abs/2609.26402)
...
### [261] [DeepFEAv2: Deep Learning for Transient Finite Element Analysis Beyond Structured Meshes](https://arxiv.org/abs/2609.26426)
...
### [262] [One-Step Generative Surrogate Models via Block-Triangular Joint Drifting](https://arxiv.org/abs/2609.26435)
...
### [263] [Can We Predict Anomaly Detection Performance from Embedding-Space Geometry?](https://arxiv.org/abs/2609.26460)
...
### [264] [When Recursive Models Finish Computing](https://arxiv.org/abs/2609.26487)
...
### [265] [Notes on Fourier-Bessel wavelets](https://arxiv.org/abs/2609.26537)
...
### [266] [Towards Hierarchical GNNs for multi-grid power flow: generalization across operating scenarios](https://arxiv.org/abs/2609.26603)
...
### [267] [Greedy Decoding Is Not Precision-Invariant: Cross-Precision Output Divergence in LLM Inference](https://arxiv.org/abs/2609.26621)
...
### [268] [Label-Efficient Learning for Ground-Based Sky-Image Classification: A Benchmark of Transfer Learning, Active Learning, and Pseudo-Labeling on GCD](https://arxiv.org/abs/2609.26631)
...
### [269] [MAGIC: Mixed-Granularity Agent Graphs via Incremental Construction with Dense-Reward Reinforcement Learning](https://arxiv.org/abs/2609.26667)
...
### [270] [A Spectral Theory of Grokking: Weight Decay induces Feature Learning](https://arxiv.org/abs/2609.26679)
...
### [271] [Train Where the Quantized Model Goes: On-Policy Distillation for Low-Bit Reasoning](https://arxiv.org/abs/2609.26708)
...
### [272] [The Sirens' Song: When Proximal Background Context Overshadows Distant Evidence](https://arxiv.org/abs/2609.26718)
...
### [273] [EquivSVA: A Formally Verified Dataset of Behavioral Assertions Across Equivalent RTL Implementations](https://arxiv.org/abs/2609.26751)
*FNU Aditi*
...
### [274] [Compressibility is not Feedback: A Random-access Gap in Causal Semantic Repair](https://arxiv.org/abs/2609.25020)
*Milad Bafarassat*
...
### [275] [Subspace coverings and generalized covering radii of generalized Zetterberg codes](https://arxiv.org/abs/2609.25115)
...
### [276] [The ISAC Tradeoff Cliff: Fundamental Limits under Waveform Uncertainty and Finite Blocklength](https://arxiv.org/abs/2609.25589)
...
### [277] [On the OpenAI whole-cube bound](https://arxiv.org/abs/2609.26050)
*Alex Samorodnitsky*
...
### [278] [Joint Quantized Precoding and Bit Allocation for Fronthaul-Constrained Cell-Free Massive MIMO](https://arxiv.org/abs/2609.26149)
*Özlem Tuğfe Demir*
...
### [279] [Fronthaul-Efficient Cell-Free Massive MIMO via Stream-Adaptive Resolution Control](https://arxiv.org/abs/2609.26150)
...
### [280] [When to Stop? Dynamic Early Termination of Sequential Ensembles](https://arxiv.org/abs/2609.26215)
...
### [281] [Support-Primitive Decomposition of Constacyclic Codes over Finite Fields: Coefficients-Based and Roots-Based Descriptions](https://arxiv.org/abs/2609.26414)
*Li Zhu,Hongfeng Wu*
...
### [282] [The Most Informative Bit and Beyond: A Proof of the Courtade--Kumar Conjecture and Multibit Extensions](https://arxiv.org/abs/2609.26444)
...
### [283] [Annihilator and twisted Euclidean duality for quasi-polycyclic codes](https://arxiv.org/abs/2609.26633)
...
### [284] [Lower Bounds for all List-Decodable Deletion Codes](https://arxiv.org/abs/2609.26650)
*Andrew D. Lin*
...
### [285] [Do Synthetic Personas Predict Real Audience Response? A Sim-to-Real Study Where a No-Persona Baseline Beats Persona-Based Copy Simulation](https://arxiv.org/abs/2609.25010)
...
### [286] [Do Existing Preconditioners Improve Biomedical Tabular Foundation Learning? An Empirical Study on TabPFN Optimization](https://arxiv.org/abs/2609.25013)
...
### [287] [4DGS-JEPA: Temporally Compositional Joint-Embedding Prediction for Dynamic Gaussian Splatting](https://arxiv.org/abs/2609.25036)
*Yongchao Huang*
...
### [288] [An Accurate and Interpretable Hyper Graph Neural Network for GBM Survival Prediction](https://arxiv.org/abs/2609.25088)
*Mushahid Intesum*
...
### [289] [Ovis-Embedding: Pushing the Frontiers of Universal Omni-Modal Embeddings](https://arxiv.org/abs/2609.25165)
*Ovis-Embedding Team*
...
### [290] [X-Planner: Event-Structured Task Planning for Embodied Intelligence](https://arxiv.org/abs/2609.25187)
...
### [291] [Lean Pool: An AI-Maintained Archive of Formalized Mathematics](https://arxiv.org/abs/2609.25199)
*Vasily Ilin*
...
### [292] [The AI Neuroscientist: An Interactive Agentic Interface for Neuroimaging Analysis](https://arxiv.org/abs/2609.25254)
...
### [293] [MedGate-Fusion: Integrating First-Encounter Semantic Narratives and Physiological Biomarkers for Prospective Stroke Risk Stratification](https://arxiv.org/abs/2609.25272)
...
### [294] [When LLM Agents Fail to Read the Room: ReAdapt for Relational Social Reasoning](https://arxiv.org/abs/2609.25284)
...
### [295] [Attention as a Routing Graph: Live Circuit Extraction from a Single Forward Pass](https://arxiv.org/abs/2609.25285)
...
### [296] [Learned Enterprise Data Comprehension: Compression and Routing for Data Agents](https://arxiv.org/abs/2609.25286)
...
### [297] [Agentic Algorithm Engineering: Improving Shared-Memory Exact Minimum Cuts](https://arxiv.org/abs/2609.07204)
...
### [298] [Making Agents More Consistent: Skills Should Form Habits for Repeat Tasks](https://arxiv.org/abs/2609.25299)
...
### [299] [Potential for Enhanced Learning in Machine Learning Classes by Using Wiki LLM Indexing](https://arxiv.org/abs/2609.25303)
*Brian Wright*
...
### [300] [Clarification Is Not Correction: LLMs Fail to Let Go](https://arxiv.org/abs/2609.25337)
...
### [301] [From Decorative to Load-Bearing: Task Difficulty Shapes the Causal Role of Chain-of-Thought](https://arxiv.org/abs/2609.25366)
*Renee Jia,Di Mu*
...
### [302] [Neutral-Atom-based Quantum Optimization for Resource Allocation in NOMA Networks](https://arxiv.org/abs/2609.26556)
...
### [303] [Robust Failure, Conservative Repair: Textual Knowledge Distillation from Cross-Model Failures](https://arxiv.org/abs/2609.25400)
...
### [304] [Efficient Iterative Retrieval with Heterogeneous Batching](https://arxiv.org/abs/2609.25405)
...
### [305] [From Offline Proxies to Online Decisions: A Layered Engagement Evaluation Framework for Conversational AI](https://arxiv.org/abs/2609.25408)
...
### [306] [Reliability Theory for AI Control](https://arxiv.org/abs/2609.26419)
*Grant Molnar*
...
### [307] [ZeroGate: Trust-Preserving Fast Paths for Governed AI Agent Runtimes](https://arxiv.org/abs/2609.25443)
*Zexun Wang*
...
### [308] [Direct Optimization of Generators for Search in Automated Theorem Proving](https://arxiv.org/abs/2609.25575)
...
### [309] [Rollout Efficiency in Reinforcement Learning for Reasoning Large Language Models: A Taxonomy and Future Directions](https://arxiv.org/abs/2609.25463)
...
### [310] [Real-Time Hand Gesture Recognition for OpenXR Using Transformer-Based Machine Learning](https://arxiv.org/abs/2609.25466)
...
### [311] [ShowTellArena: Evaluating Business Workflow Understanding from Demonstrations](https://arxiv.org/abs/2609.25467)
...
### [312] [RAG-NAROK: Retrieval-Aware Knowledge Corpus Poisoning in RAG with Source-specific Refutation](https://arxiv.org/abs/2609.25469)
...
### [313] [Spectra: A Rules-Driven LLM Pipeline for Automated KYC Document Processing](https://arxiv.org/abs/2609.25474)
...
### [314] [Improved Multiplayer Bandit Algorithm for Bernoulli Rewards](https://arxiv.org/abs/2609.26213)
...
### [315] [Queer inclusion in speech datasets: An audit and taxonomy of practical tensions](https://arxiv.org/abs/2609.25491)
...
### [316] [Towards participatory speech dataset curation: A queer case study and conceptual framework](https://arxiv.org/abs/2609.25496)
*Brooklyn Sheppard,Anaelia Ovalle,Adina Williams,Levent Sagun*
...
### [317] [SMTB: Fast Structure-Mapping with Tight Bounds](https://arxiv.org/abs/2609.25508)
...
### [318] [Weakly Supervised Quantum Error Mitigation](https://arxiv.org/abs/2609.25555)
...
### [319] [Recovering Agentic Sovereignty: Mitigating the Consensus Paradox via Contrastive Epistemic Decoding](https://arxiv.org/abs/2609.25570)
...
### [320] [A Behavioral Trait Leaks into Preferences: Diagnosing Trait Interference in LLM User Simulators](https://arxiv.org/abs/2609.25572)
...
### [321] [Gaze responses to false-positive computer-aided detection prompts during colonoscopy: a paired-video and real-time eye-tracking study](https://arxiv.org/abs/2609.25581)
...
### [322] [Transformer Heads Looking for Order](https://arxiv.org/abs/2609.25588)
...
### [323] [Evaluating Coding Agents on Kernel Exploit Generation](https://arxiv.org/abs/2609.25591)
...
### [324] [ArticleMiner: Ontology-Guided Knowledge Graph Construction from Scientific Publications](https://arxiv.org/abs/2609.25607)
...
### [325] [Reasoning-Preserving Fine-Tuning of Post-RL LLMs with Null-Basis LoRA](https://arxiv.org/abs/2609.25618)
...
### [326] [ChatT2: An Adaptive Framework for Developing a Large Language Model-Based Agent for Natural Product Domain Research](https://arxiv.org/abs/2609.25620)
...
### [327] [Ladders of Thought: A Self-Evolving Curriculum of Progressively Simplified Reasoning Traces](https://arxiv.org/abs/2609.25643)
...
### [328] [Testing-Driven Reliability Audit of Trajectory-Based Early Outcome Prediction for LLM Agents: Target-Specific Calibration Transfer Persists Within a Single Benchmark](https://arxiv.org/abs/2609.25647)
*YanZe Cao*
...
### [329] [Seeing Is Not Perceiving: When Synthetic Consumers Can and Cannot Pretest Visual Marketing](https://arxiv.org/abs/2609.25677)
...
### [330] [Toolcompass: Guiding Tool Trialing, Not Suppressing It](https://arxiv.org/abs/2609.25678)
...
### [331] [How Strongly Should Task State Influence an LLM Agent?](https://arxiv.org/abs/2609.25686)
...
### [332] [TCMaster: Confidence-Aware Querying and Workload-Guided Physical Design for Multi-Source Traditional Chinese Medicine Knowledge Graphs](https://arxiv.org/abs/2609.25712)
...
### [333] [LingLan: An Advancing Traditional Chinese Medicine Diagnosis LLM with Multimodal Data](https://arxiv.org/abs/2609.25715)
...
### [334] [OmniFysics-Nano-V2 Technical Report: Understanding the Physical World Across Modalities](https://arxiv.org/abs/2609.25738)
...
### [335] [The Limits of Simulated Societies: How Post-Training and Survey Fine-Tuning Erase Cross-Cultural Variance](https://arxiv.org/abs/2609.25760)
*Rojin Ziaei*
...
### [336] [Neurosymbolic Action Model Learning under Partial Observability](https://arxiv.org/abs/2609.25766)
...
### [337] [Towards Omni-dimensional GUI Agent Navigation with Masked Trajectory Prediction](https://arxiv.org/abs/2609.25769)
...
### [338] [The Tasteful Agent: Measuring and Improving Taste in Long-Horizon Tasks](https://arxiv.org/abs/2609.25804)
...
### [339] [Selection-Invariant Communication Compilers for Privacy-Aware Multi-Agent LLM Workflows](https://arxiv.org/abs/2609.26076)
*Jinghan Xu,Longze Fan,Zeyuan Wang,Xinjin Li,Hankai Liu*
...
### [340] [When Are Aggregate Agent Traces Diagnosable? Traffic-Governed Interpretation and Calibrated Abstention](https://arxiv.org/abs/2609.25806)
...
### [341] [Optimizing the Score, Losing Sight of the Task: Reward Hacking Across Weights, Selection, and Prompts](https://arxiv.org/abs/2609.25848)
*Vansh Wahi*
...
### [342] [Prediction Is Not Detection: Evaluating Pre-Recognition Claims in Longitudinal Clinical AI](https://arxiv.org/abs/2609.25852)
...
### [343] [AgenticSizing: A Large Language Model-based Multi-Agent Framework for Analog Circuit Sizing](https://arxiv.org/abs/2609.25873)
...
### [344] [CausalLoss-Fin: Attributing Financial-Agent Loss to Decisions and Infrastructure Faults](https://arxiv.org/abs/2609.25960)
*Abhishek Sharma*
...
### [345] [VideoX-Qwen: Data-Centric Instruction-Based Video Editing](https://arxiv.org/abs/2609.26015)
...
### [346] [CQ4OE: A benchmark for assessing LLM-assisted ontology generation from competency questions](https://arxiv.org/abs/2609.26029)
...
### [347] [Canonical locks that encode part-whole hierarchies](https://arxiv.org/abs/2609.26046)
...
### [348] [FIRE: Failure-Informed Runtime Engineering for Reliable Language-Model Agents](https://arxiv.org/abs/2609.26048)
...
### [349] [Adversarial Course-of-Action Generation: Game-Theoretic Multi-Agent Algorithms for COA matching & COA generation](https://arxiv.org/abs/2609.26059)
...
### [350] [ChainUQ: Reasoning Consistency-Aware Uncertainty Quantification for Large Language Models](https://arxiv.org/abs/2609.26060)
...
### [351] [RankCert: When Can Simulated Learners Safely Select an AI Tutor? Robust Decision Certification Under Structural Uncertainty](https://arxiv.org/abs/2609.26069)
*Nizam Kadir*
...
### [352] [The Architect, the Adversary, and the Judge: Closed-Loop Generation of Standards-Aligned Assessment Items at Scale](https://arxiv.org/abs/2609.26087)
...
### [353] [FusionMMT: A Unified Multimodal and Multitask Learning Framework for Nuclear Fusion](https://arxiv.org/abs/2609.26095)
...
### [354] [Neoadjuvant chemotherapy response prediction using pretreatment diffusion and contrast-enhanced magnetic resonance imaging with clinical variables](https://arxiv.org/abs/2609.26105)
...
### [355] [Early Prediction of Pathological Complete Response to Neoadjuvant Chemotherapy Using Temporal Deep Learning on DWI](https://arxiv.org/abs/2609.26106)
...
### [356] [DTOC: Dynamic Tool Output Compression for Adaptive Context Management in AI Agents](https://arxiv.org/abs/2609.26121)
...
### [357] [FairMon: A Tool for Monitoring and Visualizing Algorithmic Fairness](https://arxiv.org/abs/2609.26123)
...
### [358] [MAC-RRG: Iterative Multi-Agent Collaboration for X-ray Radiology Report Generation](https://arxiv.org/abs/2609.26124)
...
### [359] [When Big Data Becomes a Curse: Spatial Heterogeneity and the Limits of Learning from Passive Acoustic Monitoring Data](https://arxiv.org/abs/2609.26125)
...
### [360] [The Cost of Conservation: Coordination-Memory Laws for Exact-Support Generation](https://arxiv.org/abs/2609.26126)
...
### [361] [VACS: Value-Aligned Compositional Shielding for Multi-Agent Reasoning](https://arxiv.org/abs/2609.26135)
...
### [362] [When Verifiers Vote Backwards under Verdict Substitution: Signed Pivotal Value in Correlated Self-Consistency](https://arxiv.org/abs/2609.26144)
*Yang Shu*
...
### [363] [Unanimity Without Persuasion: A Single Round of Debate Erases the Disagreement That Verification Needs](https://arxiv.org/abs/2609.26145)
*Yang Shu*
...
### [364] [Toward User-Mediated Self-Repair in Ubiquitous Robots Through Goal-Oriented Agentic AI](https://arxiv.org/abs/2609.26157)
...
### [365] [The Free-Recipe Limit: Every Recipe Effect Measures Which Premise of an Idealised Learner Broke](https://arxiv.org/abs/2609.26160)
...
### [366] [EADC: Evaluation of Advanced and Deep-level Compliance in Large Language Models](https://arxiv.org/abs/2609.26175)
...
### [367] [TREND-10K: A Comprehensive Dataset for Next-Generation Video Quality Assessment Based on Preference-Driven Media](https://arxiv.org/abs/2609.26187)
...
### [368] [Identifying Intelligent Processes via Online Sequential Testing](https://arxiv.org/abs/2609.26193)
...
### [369] [RCShift: Certifying When Partial Linkage Suffices for Finite-Sample Decisions](https://arxiv.org/abs/2609.26207)
...
### [370] [A Hybrid AI Framework for Academic Advising: Integrating Ensemble-Based Grade Prediction and a Rule-Based Expert System](https://arxiv.org/abs/2609.26243)
...
### [371] [A Multi-Timestep LSTM Ensemble regressor for Enhanced Short-Term Runoff Prediction](https://arxiv.org/abs/2609.26244)
...
### [372] [Coding Agents are Strong Prompt Optimizers](https://arxiv.org/abs/2609.26261)
...
### [373] [Decoupling Is Not Identification: Supervised Evidential Learning in Next-Token Prediction](https://arxiv.org/abs/2609.26268)
*Ge Wang*
...
### [374] [FISSION: Label Augmentation for Bot Detection](https://arxiv.org/abs/2609.26279)
...
### [375] [Dual-Frontier: When Can an Agent Trust Its World Model?](https://arxiv.org/abs/2609.26293)
...
### [376] [The Source of Disturbance Matters: External, Internal, and Control-Generated Noise in Adaptive Regulation](https://arxiv.org/abs/2609.26428)
*Veronique Ziegler*
...
### [377] [Recursive self-improvement of AI research agents](https://arxiv.org/abs/2609.26457)
...
### [378] [Reproducible AI Requires Reproducible Randomness](https://arxiv.org/abs/2609.26461)
...
### [379] [REFLEX with Jev for Efficient Selective Control in LLM Agents](https://arxiv.org/abs/2609.26532)
...
### [380] [JEV-as-a-Judge: Accept When Confident, Escalate When Unsure](https://arxiv.org/abs/2609.26550)
...
### [381] [Quantum-Aided Active Device Detection in Energy-Harvesting Symbiotic Radio Networks](https://arxiv.org/abs/2609.26565)
...
### [382] [The Delegation Blind Spot: Auditing Product Decisions from Agent Choices](https://arxiv.org/abs/2609.26642)
*Shivam Gupta*
...
### [383] [Type-Safe Is Not Error-Free: A Constrained Decision Head Follows the Option Name, Not the Rubric Bound to It](https://arxiv.org/abs/2609.26758)
*Yu Sun,Junhao Xu*
...
### [384] [Grow the Harness, Not the Context: From Strategy-Free Scaffolds to Reusable Specialist Agents](https://arxiv.org/abs/2609.26760)
...
### [385] [SWE-Serve: Benchmarking Agentic Engineering For Production Inference Serving](https://arxiv.org/abs/2609.26777)
...
### [386] [CliffCompaction: Cost-Efficient Compaction for Long-Horizon Coding Agents](https://arxiv.org/abs/2609.26779)
...
### [387] [Higher-Order Sensitivity Analysis of Wasserstein and Adapted Wasserstein Distributionally Robust Optimization Problems](https://arxiv.org/abs/2609.25345)
*Nathan Sauldubois*
...
### [388] [Optimal Control of Traveler Testing in Epidemic Models](https://arxiv.org/abs/2609.25372)
...
### [389] [Data-Driven Control in Infinite-Dimensional Spaces: Fundamental Lemma and Applications](https://arxiv.org/abs/2609.25431)
...
### [390] [Transformer-Informed Trajectory Optimization for Relative Motion in Cislunar Orbits](https://arxiv.org/abs/2609.25460)
...
### [391] [Open Quadratic Optimization Programs](https://arxiv.org/abs/2609.25698)
*Alberto Padoan*
...
### [392] [On the optimal control of entry-exit phenomena in planar fast-slow dynamical systems](https://arxiv.org/abs/2609.25747)
...
### [393] [Efficient Parameter-Free First-Order Methods for Nonsmooth Composite Minimax Optimization](https://arxiv.org/abs/2609.25752)
...
### [394] [Doubly exponential convergence of the cyclic steepest descent method for strictly convex quadratics in arbitrary dimensions](https://arxiv.org/abs/2609.25800)
*Ran Gu*
...
### [395] [A Bounded Degree SOS Plus SONC Hierarchy for Polynomial Optimization](https://arxiv.org/abs/2609.25954)
...
### [396] [Volumes of the strong and weak relaxations of the uncapacitated facility-location polytope](https://arxiv.org/abs/2609.25981)
*Jon Lee*
...
### [397] [Sample-Based Prophet Inequalities for Random Walks](https://arxiv.org/abs/2609.26017)
...
### [398] [Optimal Fast Charging of All-Solid-State Batteries under Cathode Transport Constraints](https://arxiv.org/abs/2609.26524)
...
### [399] [Optimal nodal control and the exponential turnpike property for the flow in gas networks](https://arxiv.org/abs/2609.26572)
...
### [400] [Polyak-Type Extragradient Methods for Monotone Root-Finding Problems](https://arxiv.org/abs/2609.26581)
...
### [401] [Convergence Analysis of an Inexact Proximal Trust-Region Method](https://arxiv.org/abs/2609.26747)
...
### [402] [A Decentralized Partially Observable Team Decision Methodology with Delayed Information Sharing](https://arxiv.org/abs/2609.26783)
...
### [403] [What Does Chain-of-Thought Entropy Measure? A Channel Audit of Scaffolding, Routing, and Content](https://arxiv.org/abs/2609.25039)
...
### [404] [FREESIA: Covariance-Aware Posterior Transport for Expressive and Scalable Data Assimilation](https://arxiv.org/abs/2609.25085)
...
### [405] [Variational objectives for amortized Bayesian inference in inverse problems: The role of posterior conditioning](https://arxiv.org/abs/2609.25145)
...
### [406] [Empirical Auditing of Edge-Private Graph Generators](https://arxiv.org/abs/2609.25155)
...
### [407] [Penalized Nonreversible Langevin for Constrained Sampling](https://arxiv.org/abs/2609.25381)
...
### [408] [PICPIs: Prediction-Interval-Conditional Prediction Intervals](https://arxiv.org/abs/2609.25388)
...
### [409] [Scalable Minimum-Volume Simplex Estimation with Non-asymptotic Analysis](https://arxiv.org/abs/2609.25576)
...
### [410] [Generalized Deep Regression for Repeated Measurements](https://arxiv.org/abs/2609.25605)
*Kexuan Li*
...
### [411] [On the Gradient Heterogeneity Dynamics of Adversarially Robust Federated Regression](https://arxiv.org/abs/2609.25705)
...
### [412] [Optimal Tradeoffs Between Network Size and Parameter Magnitude in Neural Approximation and Minimax Regression](https://arxiv.org/abs/2609.25710)
...
### [413] [Statistical Gains from Looped Estimation under Parameter Budgets](https://arxiv.org/abs/2609.25778)
...
### [414] [Conditional Tensor Diffusion: Distributional Counterfactual Learning and Inference](https://arxiv.org/abs/2609.25924)
...
### [415] [Learning to Fluctuate: Statistical Foundations for Causal Tabular Pretraining](https://arxiv.org/abs/2609.26290)
*Zhiheng Zhang*
...
### [416] [Error Bounds for Statistical Estimators in BTL Model with Parametric Multivariate Utility Functions](https://arxiv.org/abs/2609.26326)
*Yicheng Li,Huifu Xu*
...
### [417] [SuperPCA: subspace analysis and an efficient algorithm for high-dimensional PCA](https://arxiv.org/abs/2609.26406)
...
### [418] [A Practical Guide on Graphical Model Validation](https://arxiv.org/abs/2609.26445)
*Mario V. Wüthrich*
...
### [419] [On Basis Function Selection for Sparse Gaussian Process Regression](https://arxiv.org/abs/2609.26624)
...
### [420] [On the Offline Version of the Time-Optimal k-Server Problem](https://arxiv.org/abs/2609.25180)
*Oleg Lomachenko*
...
### [421] [Near-Optimal Online Metric Matching on $Δ$-ary HST](https://arxiv.org/abs/2609.25292)
...
Abstract: Translocations are genome rearrangement operations that exchange prefixes of two chromosomes. We study the non-uniform non-contiguous translocation distance problem, where every string produced during the computation remains available for reuse. Given an initial set of strings $A$ and a target set $B$, the objective is to produce all strings in $B$ using as few translocations as possible.
...
### [423] [Linear-Query Deterministic Approximation for Non-monotone Submodular Maximization under a Knapsack Constraint](https://arxiv.org/abs/2609.25679)
...
### [424] [Structural Complexity of Matching-Match: Dense and Sparse Graphs](https://arxiv.org/abs/2609.26006)
...
### [425] [An $\widetilde{O}\left(n^3 \right)$-Time Sampler for Zero-Field Ferromagnetic Ising Models](https://arxiv.org/abs/2609.26197)
*Weiming Feng,Heng Guo,Yiyao Zhang*
...
Abstract: We give an approximate sampler for ferromagnetic Ising models with no field on arbitrary graphs that runs in time $\widetilde O(m+n)+\widetilde O_β\left(n^3\log^3\frac{1}ε\right)$, where $n$ and $m$ are the numbers of vertices and edges, respectively, and $ε$ is the approximation error. Our algorithm utilises the machinery behind the classic cut sparsifier by Benczúr and Karger (2015) and the transport flow idea by Chen, Feng, Ju, Miao, Yin, and Zhang (2025). The main proofs were found using GPT-5.6 Sol Pro.

</details>


### [426] [Approximate Counting of $k$-Paths in $O^*(2^k)$ Time](https://arxiv.org/abs/2609.26246)
*Tomohiro Koana*
...
Abstract: We resolve the conjecture of Koutis and Williams that $k$-paths can be approximately counted in $O^*(2^k)$ time. For a simple directed graph with $n$ vertices and $m$ arcs, our randomized algorithm returns a $(1\pm\varepsilon)$-approximation with failure probability at most $δ$ in $O^*(2^k\varepsilon^{-2}\log(1/δ))$ time.

</details>


### [427] [Online Line Aggregation with Deadlines: Randomized Guarantees and Learning-Augmented Tradeoffs](https://arxiv.org/abs/2609.26259)
*Tianhang Lu*
...
### [429] [Pangenome Optimization via Elastic Degenerate Strings](https://arxiv.org/abs/2609.26542)
*Nicola Rizzo,Sebastian Visan-Draghicescu,Nadia Pisanti,Veli Mäkinen*
...
Abstract: In the unrestricted max--min metric $T$-join problem, one seeks an even terminal set $T$ maximizing the cost of a minimum $T$-join. Iwata and Ravi gave a factor-$3/2$ approximation for this problem. We show that this guarantee is tight under the Unique Games Conjecture: no polynomial-time approximation with factor strictly smaller than $3/2$ exists under UGC.
  We then consider the exact-cardinality variant, which prescribes an even number \(k\) of terminals. Writing \(p:=k/n\), we give a deterministic polynomial-time \(ρ(p)\)-approximation for every feasible cardinality, where
...
### [431] [Polylogarithmic Collective Tree Exploration](https://arxiv.org/abs/2609.26789)
