...
### [4] [MixGuard: Towards Detecting and Understanding Mixer Laundering on Ethereum](https://arxiv.org/abs/2609.27807)
*Qishuang Fu,Hang Zheng,Xihan Xiong,Joseph K. Liu,Yixin Liu,Shirui Pan,Qin Wang,Weiqing Wang,Zhipeng Wang,Tsz Hon Yuen*
...
### [5] [Ajar: Measuring Open Privilege in Agent Defenses](https://arxiv.org/abs/2609.26900)
...
### [7] [TimeEvo: Failure-Driven Self-Evolution of a Time Series Agent](https://arxiv.org/abs/2609.27277)
...
### [8] [Verifiable Hidden Dynamics Play: Generating Agentic RL Environments from Solved Mechanisms](https://arxiv.org/abs/2609.27321)
...
### [9] [Just-in-Time Memory: Learning to Curate Task-Adaptive Memory for LLM Agents](https://arxiv.org/abs/2609.27334)
...
### [10] [CART: Closed-Loop Adaptive Red Teaming for Large Language Models](https://arxiv.org/abs/2609.27336)
...
### [13] [SHRAV: State-Hypothesis-Reason-Action-Verify Framework for Physical Modeling and Inverse Design](https://arxiv.org/abs/2609.27621)
*Ziheng Guo,Yang Bu*
...
### [15] [Alignment of LRMs via Counter-Aligned Few-Shot Conversation Exposure](https://arxiv.org/abs/2609.27763)
...
### [16] [Learning What to Activate: Combinatorial Capability Allocation for Long-Horizon Multimodal Agents](https://arxiv.org/abs/2609.27869)
...
### [17] [Finite-Sample Probabilistic Safety Certification for AI-Based Grid-Edge Coordination](https://arxiv.org/abs/2609.28182)
...
### [18] [MolDesignBench: Evaluating LLM-based Agent for Scenario-grounded Molecular Design](https://arxiv.org/abs/2609.27349)
...
### [19] [Cubical Sheaf Complexes with Constant Expansion with Applications to Asymptotically Good qLTCs](https://arxiv.org/abs/2609.28028)
...
### [21] [Spread and Scale: What Determines Whether Test-Time Budget Allocation Pays](https://arxiv.org/abs/2609.27917)
*Jinhyung Bae*
...
### [22] [Resource-Adaptive Stochastic Gradient Descent for Online Linear Programming without Re-solving](https://arxiv.org/abs/2609.28263)
*Jiameng Lyu*
...
### [23] [Quantization-Robust Unlearning through the Lens of Retain-Forget Loss Landscapes Interaction](https://arxiv.org/abs/2609.27355)
...
### [25] [Does Step Law Transfer to Small-Scale Language Models? An Empirical Recalibration Below 59M Parameters](https://arxiv.org/abs/2609.27581)
...
### [26] [Hidden not Deleted: How Networks Suppress Entangled Features](https://arxiv.org/abs/2609.27593)
...
### [27] [Attention-based representations for multi-task computation](https://arxiv.org/abs/2608.04243)
...
### [30] [Forecast Workflow Bench: Evaluating Language-Model Decisions with Budgeted Forecast Tools](https://arxiv.org/abs/2609.27385)
*Shunya Nagashima*
...
### [31] [Always-Correct Succinct Dynamic Fusion Nodes Are Impossible: A Cell-Probe Lower Bound in the Small-Set, Large-Universe Regime](https://arxiv.org/abs/2609.27945)
*Ian D'Ambrosio*
